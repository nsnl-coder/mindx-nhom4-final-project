...
const App = () => {
  ...
  return (
    <ContextProvider>
      <div className="absolute -top-5 md:-top-2 right-1 md:right-2 xl:right-10 z-10">
        <div className="dropdown dropdown-hover dropdown-end pl-6 text-text">
          ...
          <div className="collapse-content text-md rounded-xl bg-white">
            <ul tabIndex={0} className="dropdown-content menu w-32 bg-base-100 top-24 shadow-md rounded-xl">
