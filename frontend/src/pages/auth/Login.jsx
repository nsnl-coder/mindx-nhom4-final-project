    ...
    <div className="flex items-center justify-center h-screen text-black">
      <div className="w-[550px] shadow-md shadow-gray rounded-md p-10 border-[1px] border-gray">
        <div className="flex justify-between">
          <div>
            <h1 className="text-3xl font-semibold text-black mb-5">Welcome back!</h1>
        ...
        <div>
          <form>
            ...
            <p className="font-[600] text-[17px] mb-4">
              Don't you have an account? <span className="text-primary text-lg cursor-pointer">Create new </span>now!
            </p>
            <p className="text-black font-semibold hover:underline cursor-pointer">Forgotten password?</p>
          </form>
        </div>
      </div>
    </div>
